...
X
y = df_real.daily_music_hr # creates an array - recommended to use for models
y.value_counts()
...
np.mean(cross_val_score(xgb, X_train, y_train, scoring = 'neg_mean_absolute_error', cv = 15))
'''
...
print(model.predict[[2,3,100, 18, 1]])
